...
\node[anchor=north west, 
     ...
     {\includegraphics[width=14.75mm,keepaspectratio]{Figures/Logos/\dtulogocolour_\targetcolourmodel.pdf}}; 
\end{tikzpicture}
...
\node[anchor=south, % anchor is bottom of picture
     ...
     {\includegraphics[height=18.9cm,keepaspectratio]{Figures/Frontpage.png}};
\end{tikzpicture}
